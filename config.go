...
const (
	...
	defaultUtreexoRootVerifyHeight = -1
)
...
type config struct {
	...
	UtreexoWorker           bool          `long:"utreexoworker" description:"The height of the utreexo root to checkfor"`
...
func loadConfig() (*config, []string, error) {
	...
	cfg := config{
		...
		UtreexoRootVerifyHeight: defaultUtreexoRootVerifyHeight,
	}
